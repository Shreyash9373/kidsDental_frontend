...
const About = () => {
  return (
    <div className="container mx-auto px-5 py-10">
      ...
      {/* Title Section */}
      <h1 className="text-4xl font-bold text-center heading-text mb-10">About Us</h1>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-5">
        ...
        <div className="w-full lg:w-1/2 p-5 bg-primary rounded-lg shadow-md">
          <h1 className='text-[40px] heading-text mb-4 font-bold'>Kids Dental World</h1>
          ...
          <h2 className="text-2xl font-semibold heading-text mb-4">Our Values</h2>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-5">
        ...
        {/* Right Section */}
        <div className="w-full lg:w-1/2 p-5 bg-primary rounded-lg shadow-md">
          <h1 className='text-[40px] heading-text mb-4 font-bold'>Meet Dr. ____</h1>
          <p className="text-lg text-gray-700 mb-4">
